...
```
composer require "igorkri/yii2-adminlte3=~1.1"
```

or add

```
"igorkri/yii2-adminlte3": "~1.1"
```
...
'components' => [
    'view' => [
         'theme' => [
             'pathMap' => [
                '@app/views' => '@vendor/igorkri/yii2-adminlte3/src/views'
             ],
         ],
    ],
],
...
Copy files from @vendor/igorkri/yii2-adminlte3/src/views to @app/views, then edit.
...
```
more for [widgets](https://github.com/igorkri/yii2-adminlte-widgets)
...
\igorkri\adminlte3\assets\PluginAsset::register($this)->add('sweetalert2');

// or
\igorkri\adminlte3\assets\PluginAsset::register($this)->add(['sweetalert2', 'toastr']);
```
...
$bundle = \igorkri\adminlte3\assets\PluginAsset::register($this);
        ...
        'generators' => [ // here
            'crud' => [ // generator name
                ...
                'templates' => [ // setting for our templates
                    'yii2-adminlte3' => '@vendor/igorkri/yii2-adminlte3/src/gii/generators/crud/default' // template name => path to template
                ]
            ]
        ]
    ];
