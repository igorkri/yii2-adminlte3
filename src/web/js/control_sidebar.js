...
(function ($) {
    ...
    // $('.kv-node-detail').addClass('table-dark');
    // $('.kv-node-indicators').addClass('table-dark');
    // $('.kv-tree-root').addClass('table-dark');
    ...
    var $dark_mode_checkbox = $('<input />', {
        ...
        // checked: $('body').addClass('dark-mode'),
        class: 'mr-1'
    }).on('click', function () {
        if ($(this).is(':checked')) {
    ...
    var $flat_sidebar_checkbox = $('<input />', {
        type: 'checkbox',
        value: 1,
        checked: $('.nav-sidebar').addClass('nav-flat'),
    ...
    var $child_indent_sidebar_checkbox = $('<input />', {
        type: 'checkbox',
        value: 1,
        checked: $('.nav-sidebar').addClass('nav-child-indent'),
